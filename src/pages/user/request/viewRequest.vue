<template>
  <div>
    <h2 class="intro-y text-lg font-medium mt-10">My Requests</h2>
        ...
        <div class="w-full xl:w-auto flex items-center mt-3 xl:mt-0">
          <router-link to="/createrequest">
            <button class="btn btn-primary shadow-md mr-2">
              <i data-lucide="file-text" class="w-4 h-4 mr-2"></i> Add new
              request
            </button></router-link
          >
        </div>
            ...
            >
              ...
              <td class="whitespace-nowrap">
                <div class="flex items-center space-x-2">
                  <div
                    v-for="file in transaction.files.split(',')"
                    :key="file"
                    class="mr-2"
                  >
                    <a
              ...
              <td class="table-report__action">
                <div class="flex justify-center items-center">
                  ...
                  >
                    ...
                    <router-link :to="`/requesthistory/${transaction._id}`"
                      >history</router-link
                    >
                  </a>
                </div>
  ...
  methods: {
    ...
    async fetchData() {
      try {
        ...
        const response = await axios.get("/api/request/get/logeduser/request", {
          headers: {
            token: token,
          },
          params: {
        ...
        this.transactions = response.data.customerRequests;
        // console.log("Hama: ", this.transactions);
