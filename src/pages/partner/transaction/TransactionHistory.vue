<template>
    <div>
      <h2 class="intro-y text-lg font-medium mt-10">My Transactions</h2>
            ...
            <tbody>
              ...
              >
                ...
                <td class="w-40 !py-4">
                  ...
                  <div v-else class="decoration-dotted whitespace-nowrap">Individual</div>
                </td>
                ...
                <td class="table-report__action">
                  <div class="flex justify-center items-center">
                    ...
                    >
                      ...
                      <router-link
                        :to="`/updatehospitaltransaction/${transaction._id}`"
                        >Edit</router-link
                      >
                    </a>
                    <a
    ...
    methods: {
      ...
      async fetchData() {
        try {
          ...
          const response = await axios.get(`/api/gettransactionshistory/${id}`, {
            headers: {
              token: token,
            },
            params: {
          ...
          // console.log(
          //   "Hama: ",
          //   response.data.transactions[0].customerId.company.companyName
          // );
