      ...
      try {
        ...
        if (response.data.success) {
          ...
          if (response.data.user && response.data.user.company) {
            this.customerCompany = response.data.user.company;
          } else {
            // Handle the case where user.company is missing or undefined
            // You can set a default value or display an error message.
            this.customerCompany 
            // Or display an error message
            // this.errorMessage = "User company is missing in the response.";
          }
