<template>
  <div>
    <h2 class="intro-y text-lg font-medium mt-10">All Transactions</h2>
  ...
  methods: {
    ...
    async fetchData() {
      try {
        ...
        const response = await axios.get("/api/allcompanytransactions", {
          headers: {
            token: token,
          },
          params: queryParams,
        ...
        //   console.log("consolando",response.data.transactions);
