<template>
  <div>
    ...
    <div class="grid grid-cols-12 gap-12 mt-5">
      ...
      <div class="intro-y col-span-12 overflow-auto 2xl:overflow-visible mt-8">
    ...
    <div id="files-modal" class="modal mt" tabindex="-1" aria-hidden="true">
  ...
  methods: {
    ...
    async fetchData() {
      try {
        ...
        const response = await axios.get("/api/get/mytransaction", {
          headers: {
            token: token,
          },
          params: queryParams,
