<template>
  <div>
    <div class="">
      <div
        class="intro-y col-span-12 flex flex-wrap items-center mt-2 space-x-2"
      >
        <div class="w-full sm:w-auto flex items-center">
          <div class="relative text-slate-500">
            <input
              ...
              type="text"
              class="form-control w-full sm:w-56 pr-10"
              placeholder="Insert Membership ID..."
            />
            <i
              class="w-4 h-4 absolute my-auto inset-y-0 right-0 cursor-pointer"
              data-lucide="search"
              @click="searchUser"
            ></i>
          </div>
        ...
        <button
          class="btn btn-primary shadow-md flex-shrink-0 ml-3 mt-3 md:mt-0 mx-auto"
          @click="searchUser"
        >
          Search
        </button>
        ...
        <div class="">
          ...
          <div class="p-5">
            <div class="flex flex-col md:flex-row items-center">
              ...
              <div class="ml-4 md:ml-0 md:mr-auto text-center md:text-left">
              ...
              >
                ...
                <router-link :to="`/hospitaltransaction/${this.userData._id}`">
                  <button
                    class="btn btn-primary shadow-md ml-1 md:ml-5 mt-3 md:mt-0"
                  >
                    Process transaction
                  </button>
                </router-link>
            ...
            <div
              ...
              :key="member._id"
              class="relative flex flex-col md:flex-row items-center mt-5"
            >
              <div class="w-12 h-12 flex-none image-fit">
                <img
                  v-if="member.avatar"
              ...
              >
                ...
                <router-link :to="`/hospitaltransaction/${member._id}`">
                  <button
                    class="btn btn-primary shadow-md ml-1 md:ml-5 mt-3 md:mt-0"
                  >
                    Process transaction
            ...
            <div class="row mt-3">
              <div class="col-md-12 bg-light text-center md:text-right">
                <button
                  class="btn btn-secondary shadow-md ml-1 md:ml-5 mt-3 md:mt-0"
                  @click="cancel"
                >
                  Cancel
                </button>
