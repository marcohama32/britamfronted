<template>
  <div>
    ...
    <div class="intro-y flex items-center mt-8">
      <h2 class="text-lg font-medium mr-auto">Update corporate customer</h2>
      
    </div>
    <form
      @submit.prevent="onUpdateCorporate"
    ...
    async onUpdateCorporate() {
      ...
      try {
        ...
        const response = await axios.put(
          `/api/user/corporate/edit/${company}`,
          formData,
          {
            headers: {
              token: token,
