<template>
  <div>
    <div class="intro-y flex items-center mt-8">
      <h2 class="text-lg font-medium mr-auto">Update Individual Customer</h2>
      <div v-if="loading">
        ...
        <div class="intro-y col-span-12 lg:col-span-6">
          ...
          <div class="intro-y box p-5">
            ...
            <div class="grid grid-cols-3 gap-6 mt-3">
              ...
              <div>
                <!-- logica para usar, v-if main, v-if diferente de main -->
                <div v-if="relation !== `Main`">
