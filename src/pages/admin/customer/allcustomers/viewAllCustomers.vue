            ...
            >
              ...
              <td class="w-40 !py-4">
                <div
                  v-if="
                    indivUser.company &&
                    indivUser.company !== undefined
                  "
                  class="decoration-dotted whitespace-nowrap"
                >
                  {{ indivUser.company.companyName }}
                </div>
              ...
              <td class="w-40 text-right">
                <div class="pr-16">
                  {{ formatCurrency(indivUser.monthlyFee) }}
                </div>
              </td>
              <td class="w-40 !py-4">
                <div
              ...
              <td class="table-report__action">
                <div class="flex justify-center items-center">
                  ...
                  <a
                    ...
                    href="javascript:;"
                    v-if="
                      indivUser.relation === 'Main' &&
                      indivUser.status === 'Active'
                    "
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                    ...
                    <router-link
                      :to="`/createdependentindividual/${indivUser._id}`"
  ...
  methods: {
    ...
    async fetchData() {
      try {
        ...
        const response = await axios.get("/api/allcustomers", {
          headers: {
            token: token,
          },
          params: queryParams,
