<template>
  <div>
    ...
    <form
      @submit.prevent="onCreateDependent"
    ...
    getUser() {
      ...
      axios
        ...
        .then((response) => {
          ...
          this.manager = response.data.user.manager._id;
    ...
    async onCreateDependent() {
      ...
      try {
        ...
        const response = await axios.post(
          "/api/user/individualdependent/create",
          formData,
          {
            headers: {
              token: token,
        ...
        Toast.fire({
          icon: "success",
          title: "Success!",
          text: "Dependent created successfully",
          timer: 3000,
        });
