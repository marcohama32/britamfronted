  ...
  <div>
    <div class="intro-y flex items-center mt-8">
      <h2 class="text-lg font-medium mr-auto">
        Cancel Transaction ||
        <span class="text-sm font-medium mr-auto"
          >The amount will be returned to the customer's account.</span
        >
      </h2>
      <div v-if="loading">
              ...
              <div>
                ...
                <div class="input-group">
                  <textarea
                    ...
                    rows="5"
                    class="form-control"
                    placeholder="insert cancelation reason here"
                    aria-describedby="input-group-1"
                    required
                  ></textarea>
                </div>
...
export default {
  ...
  methods: {
    async cancel() {
      ...
      formData.append("cancelReason", this.cancelReason);
      // const message = {
      ...
      try {
        ...
        Swal.fire({
          ...
          title: "Warning!",
          toast: true,
          text: `Invoice ${this.invoiceNumber} canceled`,
          timer: 3000,
